...
const navData = [
  {
    ...
    subMenu: [{ name: "행성 통계", href: "/my-page/statistics" }],
  },
  {
    ...
    subMenu: [
      { name: "프로필", href: "/my-page/basic-info/profile" },
      { name: "행성", href: "/my-page/basic-info/planet" },
    ],
  },
  {
    ...
    subMenu: [
      { name: "게시글", href: "/my-page/contents/postings" },
      { name: "댓글", href: "/my-page/contents/comments" },
    ],
  },
  {
    ...
    subMenu: [
      { name: "친구 목록", href: "/my-page/friend/list" },
      { name: "친구 추가", href: "/my-page/friend/add" },
    ],
  },
  {
    ...
    subMenu: [
      { name: "행성", href: "/my-page/like/planets" },
      { name: "게시글", href: "/my-page/like/postings" },
    ],
  },
];
